			...
			["Alleta"] = {
				...
				["forms"] = {
					...
					["BearCommon"] = {
						...
						[12] = "autoAttack",
						[13] = "#Feral Charge stuns the target and disrupts any spell cast for four seconds",
						[14] = "-ifNotInCooldown=Charge",
						[15] = "# Bash stuns your target for 2 seconds and will break any ",
						[16] = "# spellcasting they are performing.  It can have a high impact if you",
						[17] = "# can for instance stop a Wailing Caverns druid from casting Sleep",
						[18] = "# or a Deadmines goblin from summoning a golem or a Deadmines",
						[19] = "# mage from casting an area of effect fireball spell, or any enemy",
						[20] = "# healer from performing a heal.  So it's high priority, and we make",
						[21] = "# a point of always trying to have 10 rage on reserve to be able to ",
						[22] = "# perform a bash whenever we find ourselves targeting an enemy",
						[23] = "# currently casting a spell",
						[24] = "bash-echo=Bash!-ifNotInCooldown=bash-ifTargetIsCasting=Sleep,Druid's Slumber-ifNotTargetIs=Stunned-ifPlayer>10rage",
						[25] = "# Growl is your taunt.  If you are peforming the tanking role (which",
						[26] = "# you should in bear form), you should be able to draw the attention",
						[27] = "# of an enemy combatant, if for example they are attacking the",
						[28] = "# healer.  ",
						[29] = "growl-echo=Growl!-ifNotInCooldown=growl-ifNotTargetOfTarget-ifTargetHasTarget",
						[30] = "# Engrage generates rage, which increases your damage and threat ",
						[31] = "# output, but reduces your armor.  So only use it when a fight is",
						[32] = "# going well, which could be defined as having over half your health",
						[33] = "enrage-echo=Enrage!-ifPlayer>50%hp-ifNotInCooldown=enrage-ifNotPlayerHasBuff=enrage",
						[34] = "# Although Demoralizing Roar only costs 10 rage the thought here",
						[35] = "# is to always have 10 spare rage on reserve available to perform a ",
						[36] = "#Bash ",
						[37] = "demoralize-echo=Demoralizing Roar!-ifPlayer>20rage-ifNotTargetHasDebuff=demoralize",
					},
					["CatCommon"] = {
