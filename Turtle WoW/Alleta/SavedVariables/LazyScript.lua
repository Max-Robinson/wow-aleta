			...
			["Alleta"] = {
				...
				["forms"] = {
					...
					["CatCommon"] = {
						...
						[36] = "rip-echo=Rip!-ifPlayer>30energy-5cp",
						[37] = "rip-echo=Rip!-ifPlayer>30energy-4cp-ifTarget<114hp",
						[38] = "rip-echo=Rip!-ifPlayer>30energy-4cp-ifTimeToDeath<12s",
						[39] = "rip-echo=Rip!-ifPlayer>30energy-3cp-ifTarget<90hp",
						[40] = "rip-echo=Rip!-ifPlayer>30energy-3cp-ifTimeToDeath<12s",
						[41] = "rip-echo=Rip!-ifPlayer>30energy-2cp-ifTarget<66hp",
						[42] = "rip-echo=Rip!-ifPlayer>30energy-2cp-ifTimeToDeath<12s",
						[43] = "rip-echo=Rip!-ifPlayer>30energy-1cp-ifTarget<42hp",
						[44] = "rip-echo=Rip!-ifPlayer>30energy-1cp-ifTimeToDeath<12s",
					},
					["MFRdruidCAT"] = {
						[1] = "claw",
					},
